...
$.getJSON(link_to_data)
    .done(function(dictionary) {
        ...
        console.log("input5",document.getElementById("startingDate").value);
...
function plot_marker(eventDict,person_position,dateFilter=true,userStartTiming=null,userEndTiming=null) {
